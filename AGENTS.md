...
- Use the root-owned Blackspire GitHub CLI wrapper for headless GitHub operations; never invoke, inspect, or propagate its fine-grained token outside that wrapper.
