...
try{
 ...
 const deps={uid:()=>0,verifySource:()=>true,stopped:()=>true,directory:()=>{},retained:p=>memory.get(p)??null,publish:(p,v)=>{assert.equal(memory.has(p),false);memory.set(p,structuredClone(v));},
