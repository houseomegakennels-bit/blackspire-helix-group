...
try{
 if(process.getuid?.()!==0||process.versions.node!=='22.23.1'||process.argv.length!==4||!['--release','--reassert-credential','--release-cloud-proof-attempt4'].includes(process.argv[2])
