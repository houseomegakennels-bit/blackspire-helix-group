...
try{
 ...
 const cloudProof=async b=>{
  const readers=await import(mode==='--release-cloud-proof-attempt8'?'../packages/zola-release/owned-n8n-cloud-attempt8-host.js':mode==='--release-cloud-proof-attempt7'?'../packages/zola-release/owned-n8n-cloud-attempt7-host.js':mode==='--release-cloud-proof-attempt6'?'../packages/zola-release/owned-n8n-cloud-attempt6-host.js':mode==='--release-cloud-proof-attempt5'?'../packages/zola-release/owned-n8n-cloud-attempt5-host.js':mode==='--release-cloud-proof-attempt4'?'../packages/zola-release/owned-n8n-cloud-attempt4-host.js':mode==='--release-cloud-proof-attempt3'?'../packages/zola-release/owned-n8n-cloud-attempt3-host.js':'../packages/zola-release/owned-n8n-cloud-host.js');
  const readComplete=mode==='--release-cloud-proof-attempt8'?readers.readCompletedOwnedN8nCloudProofAttempt8:mode==='--release-cloud-proof-attempt7'?readers.readCompletedOwnedN8nCloudProofAttempt7:mode==='--release-cloud-proof-attempt6'?readers.readCompletedOwnedN8nCloudProofAttempt6:mode==='--release-cloud-proof-attempt5'?readers.readCompletedOwnedN8nCloudProofAttempt5:mode==='--release-cloud-proof-attempt4'?readers.readCompletedOwnedN8nCloudProofAttempt4:mode==='--release-cloud-proof-attempt3'?readers.readCompletedOwnedN8nCloudProofAttempt3:mode==='--release-cloud-proof-attempt2'?readers.readCompletedOwnedN8nCloudProofAttempt2:readers.readCompletedOwnedN8nCloudProof;
  ...
  if(mode==='--release-cloud-proof-attempt8')validateOwnedN8nCloudAttempt8Continuation({complete,currentOperatorSha:operatorSha});
 ...
 const {assertConfigured,synchronize}=['--release-cloud-proof','--release-cloud-proof-attempt2','--release-cloud-proof-attempt3','--release-cloud-proof-attempt4','--release-cloud-proof-attempt5','--release-cloud-proof-attempt6','--release-cloud-proof-attempt7','--release-cloud-proof-attempt8'].includes(mode)
