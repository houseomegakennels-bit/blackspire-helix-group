...
try{
 ...
 const cloudProof=async b=>{
  ...
  if(mode==='--release-cloud-proof-attempt7')validateOwnedN8nCloudAttempt7Continuation({complete,currentOperatorSha:operatorSha});
 ...
 const {assertConfigured,synchronize}=['--release-cloud-proof','--release-cloud-proof-attempt2','--release-cloud-proof-attempt3','--release-cloud-proof-attempt4','--release-cloud-proof-attempt5','--release-cloud-proof-attempt6','--release-cloud-proof-attempt7'].includes(mode)
