import {validateOwnedN8nCloudAttempt9Continuation} from '../packages/zola-release/owned-n8n-cloud-continuation.js';
import {validateOwnedN8nCloudHistory,createOwnedN8nCloudContinuation,assertOwnedN8nCloudContinuationOperator,validateOwnedN8nCloudAttempt2Continuation,validateOwnedN8nCloudAttempt3Continuation,validateOwnedN8nCloudAttempt4Continuation,validateOwnedN8nCloudAttempt5Continuation,validateOwnedN8nCloudAttempt6Continuation,validateOwnedN8nCloudAttempt7Continuation,validateOwnedN8nCloudAttempt8Continuation} from '../packages/zola-release/owned-n8n-cloud-continuation.js';
...
try{
 ...
 if(process.getuid?.()!==0||process.versions.node!=='22.23.1'||!['--release','--reassert-credential','--release-cloud-proof','--release-cloud-proof-attempt2','--release-cloud-proof-attempt3','--release-cloud-proof-attempt4','--release-cloud-proof-attempt5','--release-cloud-proof-attempt6','--release-cloud-proof-attempt7','--release-cloud-proof-attempt8','--release-cloud-proof-attempt9'].includes(mode)||process.argv.length!==4)fail();
 ...
 const cloudProof=async b=>{
  const readers=await import(mode==='--release-cloud-proof-attempt9'?'../packages/zola-release/owned-n8n-cloud-attempt9-host.js':mode==='--release-cloud-proof-attempt8'?'../packages/zola-release/owned-n8n-cloud-attempt8-host.js':mode==='--release-cloud-proof-attempt7'?'../packages/zola-release/owned-n8n-cloud-attempt7-host.js':mode==='--release-cloud-proof-attempt6'?'../packages/zola-release/owned-n8n-cloud-attempt6-host.js':mode==='--release-cloud-proof-attempt5'?'../packages/zola-release/owned-n8n-cloud-attempt5-host.js':mode==='--release-cloud-proof-attempt4'?'../packages/zola-release/owned-n8n-cloud-attempt4-host.js':mode==='--release-cloud-proof-attempt3'?'../packages/zola-release/owned-n8n-cloud-attempt3-host.js':'../packages/zola-release/owned-n8n-cloud-host.js');
  const readComplete=mode==='--release-cloud-proof-attempt9'?readers.readCompletedOwnedN8nCloudProofAttempt9:mode==='--release-cloud-proof-attempt8'?readers.readCompletedOwnedN8nCloudProofAttempt8:mode==='--release-cloud-proof-attempt7'?readers.readCompletedOwnedN8nCloudProofAttempt7:mode==='--release-cloud-proof-attempt6'?readers.readCompletedOwnedN8nCloudProofAttempt6:mode==='--release-cloud-proof-attempt5'?readers.readCompletedOwnedN8nCloudProofAttempt5:mode==='--release-cloud-proof-attempt4'?readers.readCompletedOwnedN8nCloudProofAttempt4:mode==='--release-cloud-proof-attempt3'?readers.readCompletedOwnedN8nCloudProofAttempt3:mode==='--release-cloud-proof-attempt2'?readers.readCompletedOwnedN8nCloudProofAttempt2:readers.readCompletedOwnedN8nCloudProof;
  ...
  if(mode==='--release-cloud-proof-attempt9')validateOwnedN8nCloudAttempt9Continuation({complete,currentOperatorSha:operatorSha});
  else if(mode==='--release-cloud-proof-attempt8')validateOwnedN8nCloudAttempt8Continuation({complete,currentOperatorSha:operatorSha});
  else if(mode==='--release-cloud-proof-attempt7')validateOwnedN8nCloudAttempt7Continuation({complete,currentOperatorSha:operatorSha});
  else if(mode==='--release-cloud-proof-attempt6')validateOwnedN8nCloudAttempt6Continuation({complete,currentOperatorSha:operatorSha});
  else if(mode==='--release-cloud-proof-attempt5')validateOwnedN8nCloudAttempt5Continuation({complete,currentOperatorSha:operatorSha});
  else if(mode==='--release-cloud-proof-attempt4')validateOwnedN8nCloudAttempt4Continuation({complete,currentOperatorSha:operatorSha});
  else if(mode==='--release-cloud-proof-attempt3')validateOwnedN8nCloudAttempt3Continuation({complete,currentOperatorSha:operatorSha});
 ...
 const {assertConfigured,synchronize}=['--release-cloud-proof','--release-cloud-proof-attempt2','--release-cloud-proof-attempt3','--release-cloud-proof-attempt4','--release-cloud-proof-attempt5','--release-cloud-proof-attempt6','--release-cloud-proof-attempt7','--release-cloud-proof-attempt8','--release-cloud-proof-attempt9'].includes(mode)
