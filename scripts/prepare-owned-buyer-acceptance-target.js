...
import {prepareOwnedBuyerAcceptanceTarget} from '../packages/buyer-writer/owned-acceptance-target-preparation.js';
...
try{
  ...
  releaseGuard=openReleaseJournal();
  ...
  const connect=async (credential,ssl)=>{
    const client=new pg.Client({...credential,ssl,
      application_name:'blackspire-owned-buyer-acceptance-preparation',
