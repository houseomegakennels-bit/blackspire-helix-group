...
- `origin/main`: `691973870e0048f273fa7e9251d7f78776e3612b`, including independently reviewed PR #28 explicit-migration repair.
...
- PR #26 repository-side durable-VPS readiness work is merged by `a9602496`; its host-side activation blockers remain open. PR #29 (`fix/immutable-release-runtime-access`) is OPEN and draft at `857124a21e67a6ef7a49a4fc4da89807466346f6`; do not mark it ready, merge, rebuild staging, or deploy without separate authority.
- PR #30 (`fix/prestaging-test-inventory`) is OPEN and draft. Its verified trust-boundary/CI implementation is `f3b597fb28ee71bfe6042e0cbc428cc1c9577dd4`, and root-Vercel boundary repair is `554cb5b44bbe5f402d7fef30cbdb078d36f44639`. Keep it draft pending a fresh independent review of the current exact head; no eligible submitted GitHub review exists yet.
