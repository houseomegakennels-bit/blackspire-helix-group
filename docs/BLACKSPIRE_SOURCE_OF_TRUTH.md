...
- Last verified implementation commit: `54aae9f6253995d6c0987494f8b85441c57aee51` (unmerged trusted test-inventory repair on draft PR #30); the last verified merged implementation remains `03708c49e4772534992fbcc2fcdcabdfb40e6f1d`, merged by `691973870e0048f273fa7e9251d7f78776e3612b`.
...
- PR #30 (`fix/prestaging-test-inventory`) is OPEN and draft. Its independently reviewed pre-repair head was `5b4d3247aaf5dad5bcd54934ca0c7d8f6a6a85d8`; the verified repair implementation is `54aae9f6253995d6c0987494f8b85441c57aee51`. Keep it draft pending a fresh independent review.
...
- Trusted-inventory repair `54aae9f6253995d6c0987494f8b85441c57aee51` replaces TAP-marker and worker-writable-manifest authorization with parent IPC and one strict versioned 0600 terminal report created only after the test child exits. It rejects missing, multiple, malformed, stale, duplicate, omitted, unexpected, failed, interrupted, truncated, and substituted evidence. Locale-independent UTF-8 byte ordering replaces `localeCompare`. The repaired full run passed 274/274 with 30 intended/discovered/started/completed files, childStatus 0, complete TAP summary, and npm exit 0; 15 focused inventory/adversarial tests and 34 focused migration/release/symlink tests also passed.
...
- GitHub recovery found draft PR #30 OPEN at exact pre-repair remote head `5b4d3247aaf5dad5bcd54934ca0c7d8f6a6a85d8` with Actions success, frontend Vercel success, and required root/aggregate Vercel failures. No Vercel setting or deployment was changed; final exact-head contexts must be re-read after the repair is pushed.
