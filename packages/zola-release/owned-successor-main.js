...
export const REVIEWED_FEATURE_MAIN='3019785f108f3da78720da265bb5ccc6e17ae2d4';
export const SUCCESSOR_MAIN='f3ac3d33c00885de3ebc6d7f5313a4965e75f0e8';
...
export function observeSuccessorMain(releaseSha,{root=fileURLToPath(new URL('../../',import.meta.url)),run=execFileSync}={}){
 ...
 git(['merge-base','--is-ancestor',PREDECESSOR_MAIN,REVIEWED_FEATURE_MAIN]);
 git(['merge-base','--is-ancestor',REVIEWED_FEATURE_MAIN,SUCCESSOR_MAIN]);
