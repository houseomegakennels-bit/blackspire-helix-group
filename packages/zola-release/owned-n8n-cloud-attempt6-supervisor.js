...
export async function awaitOwnedN8nAttempt6SupervisorAcknowledgment({observe,readResult,validateReady,pid=process.pid,now=()=>performance.now(),pause=ms=>new Promise(resolve=>setTimeout(resolve,ms)),timeoutMs=10000}){
