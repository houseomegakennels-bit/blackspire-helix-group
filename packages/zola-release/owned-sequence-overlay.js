...
export function transformOwnedSequenceSource(name,source){
 if(!Object.hasOwn(OWNED_SEQUENCE_SOURCE_HASHES,name)||typeof source!=='string'||createHash('sha256').update(source).digest('hex')!==OWNED_SEQUENCE_SOURCE_HASHES[name])fail();
