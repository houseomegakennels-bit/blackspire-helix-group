...
export const BUYER_WRITER_ROUTINES=Object.freeze([
  ...
  ['buyer_writer.execute_admitted_issue(text,uuid,uuid,text,uuid,text,uuid,uuid,text,uuid,text,jsonb,jsonb,timestamp with time zone,uuid)','fc49ab22996a206974dd46d04a225e00e4d93ce616db945c8dba0917be9f2245','plpgsql',true,['search_path=pg_catalog','lock_timeout=5s'],'v'],
