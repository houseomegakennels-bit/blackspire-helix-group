...
].map(([signature,digest,language,securityDefiner,config,volatility,owner='writer'])=>Object.freeze({signature,digest,language,securityDefiner,config:Object.freeze(config),volatility,owner})));
