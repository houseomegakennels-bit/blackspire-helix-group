...
export function validateBuyerWriterConfiguration(value,{workspace}={}) {
  try {
    if(typeof workspace!=='string'||!/^[A-Za-z0-9._:-]{1,128}$/.test(workspace)
      ||!exact(value,['version','workspace','bindingFile','writerCredential','issuerCredential','runtime','issuer'])
