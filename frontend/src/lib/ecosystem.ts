...
export const ecosystemProjects: EcosystemProject[] = [
  ...
  },
  {
    ...
    description:
      "Sentinel is the executive command layer above the Blackspire real estate ecosystem. It reads Harvester, Seller Engine, Nexus, Deal Engine, Buyer Engine, and the Contract/Transaction centers, scores what matters, and surfaces a morning brief, deal-readiness scores, a ranked follow-up queue, an opportunity feed, and a unified inbox — so the operator always knows what needs attention and what to work next.",
    accent: "#2DD4BF",
    glow: "rgba(45, 212, 191, 0.34)",
    cta: "Open Sentinel",
    href: "/workspace/sentinel",
    productHref: "/workspace/sentinel",
    status: "live",
    targetUser: "Operators running the full acquisition-to-close pipeline",
    primaryOutcome: "Know what needs attention, which deal to work next, and where the value is — without hopping between systems.",
    logoSrc: brandAssets.sentinel.logo,
    monogram: "BSN",
    motif: "Winged command shield, helix sightlines, and pipeline telemetry sweeps.",
    vibe: "Executive, vigilant, and decisive.",
    surfaceTint: "rgba(45, 212, 191, 0.12)",
    edgeTint: "rgba(214, 168, 79, 0.34)",
    iconCue: "Command sentinel",
    logoMaxWidthClass: "max-w-[240px]",
    logoMaxHeightClass: "max-h-[150px]",
    featureBullets: [
      "Daily morning brief with critical items and projected revenue",
      "Deal Readiness Score and Opportunity Score across every record",
      "Smart follow-up queue, opportunity feed, and a unified inbox",
    ],
  },
  {
    slug: "harvester",
