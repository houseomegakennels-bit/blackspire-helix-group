...
export const ecosystemProjects: EcosystemProject[] = [
  ...
  },
  {
    ...
    surfaceTint: "rgba(216, 184, 90, 0.12)",
    edgeTint: "rgba(202, 219, 230, 0.38)",
  ...
  },
  {
    ...
    surfaceTint: "rgba(47, 214, 255, 0.10)",
    edgeTint: "rgba(216, 184, 90, 0.38)",
