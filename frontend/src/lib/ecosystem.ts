...
export const ecosystemProjects: EcosystemProject[] = [
  {
    ...
    logoSrc: "/brand/blackspire-buyer-engine-logo-v2.png",
    monogram: "BBE",
  ...
  },
  {
    ...
    logoSrc: "/brand/helix-lawn-command-logo.png",
    monogram: "HLC",
    ...
    logoMaxWidthClass: "max-w-[300px]",
    logoMaxHeightClass: "max-h-[128px]",
    featureBullets: [
  ...
  },
  {
    ...
    logoSrc: "/brand/blackspire-social-os-logo.png",
    monogram: "BSO",
    ...
    logoMaxWidthClass: "max-w-[300px]",
    logoMaxHeightClass: "max-h-[126px]",
    featureBullets: [
  ...
  },
  {
    ...
    logoSrc: "/brand/ember-halo-logo.png",
    monogram: "EH",
  ...
  },
  {
    ...
    logoSrc: "/brand/oracle-helix-logo.png",
    monogram: "OH",
    ...
    logoMaxHeightClass: "max-h-[132px]",
    featureBullets: [
