...
export const fallbackCountySourceRows: CountySourceRow[] = [
  ...
  { county: "Randolph", state: "NC", source_type: "arcgis", active: true, notes: "Randolph County GIS PW_ParcelMap FeatureServer (curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  ...
  // ── Wave 2 / Wave 3 parity (NC OneMap statewide feed) ──────────────────────
  { county: "Caldwell", state: "NC", source_type: "arcgis", active: true, notes: "Caldwell County GIS hosted parcel MapServer (OpenGov/layer 1). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  { county: "Chatham", state: "NC", source_type: "arcgis", active: true, notes: "Chatham County GIS LandInformation MapServer (curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  ...
  { county: "Montgomery", state: "NC", source_type: "arcgis", active: true, notes: "Montgomery County dedicated ArcGIS Online parcel FeatureServer (curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  ...
  { county: "Polk", state: "NC", source_type: "arcgis", active: true, notes: "Polk County GIS Property Appraiser FeatureServer layer 1 (curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  { county: "Transylvania", state: "NC", source_type: "arcgis", active: true, notes: "Transylvania County GIS hosted Parcels MapServer layer 0 (curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  { county: "Union", state: "NC", source_type: "arcgis", active: true, notes: "Union County dedicated ArcGIS Online Parcels FeatureServer layer 0 (curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  ...
  { county: "Watauga", state: "NC", source_type: "arcgis", active: true, notes: "Watauga County parcels via Town of Boone GIS hosted MapServer (curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
  ...
  { county: "Yancey", state: "NC", source_type: "arcgis", active: true, notes: "Yancey County GIS OperationalLayers MapServer layer 6 (TaxParcels, curated). Schema-agnostic parse; fallback to NC OneMap if zero rows." },
];
