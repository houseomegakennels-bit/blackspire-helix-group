  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
      <form onSubmit={submit} className="brand-panel space-y-5 p-6">
        ...
        <label className="block text-sm text-[var(--copy-soft)]">Access level<select name="accessLevel" defaultValue="read_only" className="brand-input mt-2 w-full"><option value="read_only">Read-only demonstration</option><option value="real_estate_operator">Interactive isolated workspace</option></select></label>
