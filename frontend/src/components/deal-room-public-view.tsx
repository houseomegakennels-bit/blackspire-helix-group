...
export function DealRoomPublicView({
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,hsl(193_100%_60%/.14),transparent_28%),radial-gradient(circle_at_78%_12%,hsl(44_73%_62%/.12),transparent_20%),linear-gradient(180deg,hsl(224_24%_4%)_0%,hsl(213_20%_4%)_24%,hsl(218_20%_6%)_100%)] text-foreground">
