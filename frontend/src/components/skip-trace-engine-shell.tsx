      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-[1800px] gap-5 px-3 py-3 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-5">
        <aside className="brand-panel h-fit overflow-hidden p-5 lg:sticky lg:top-3">
          ...
          <div className="relative border-b border-[var(--line)] pb-5">
            <div className="mb-4 flex h-[110px] items-center justify-center overflow-hidden rounded-[24px] border border-[var(--line)] bg-[linear-gradient(180deg,hsl(0_0%_6%/.92),hsl(0_0%_2%/.96))] sm:h-[172px]">
            ...
            <h1 className="brand-display mt-3 text-2xl text-white sm:text-3xl">Blackspire Skip Trace Engine</h1>
